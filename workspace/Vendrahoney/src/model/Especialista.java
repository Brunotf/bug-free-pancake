...
public class Especialista extends Veterinario {
	...
	public Especialista(String crmv, String nome, String dataNasc, String cpf, String telefone, String diasDisponiveis,
			int diasTrabalhados, double valorHora, double salario) {
		super(crmv, nome, dataNasc, cpf, telefone, diasDisponiveis,
				diasTrabalhados, valorHora, salario);
	}
